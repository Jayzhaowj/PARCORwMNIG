...
RcppExport SEXP _PARCORwMNIG_pred_dens_mix_approx(SEXP x_testSEXP, SEXP y_testSEXP, SEXP theta_srSEXP, SEXP beta_meanSEXP, SEXP sig2_sampSEXP, SEXP svSEXP, SEXP sv_phiSEXP, SEXP sv_muSEXP, SEXP sv_sigma2SEXP, SEXP chol_C_N_inv_sampSEXP, SEXP m_N_sampSEXP, SEXP MSEXP, SEXP logSEXP) {
BEGIN_RCPP
...
// do_shrinkTVP_mNIG
List do_shrinkTVP_mNIG(arma::vec y, arma::mat x, arma::vec a0, int K, int niter, int nburn, int nthin, double c0, double g0, double G0, double eta2_d1, double eta2_d2, double p_d1, double p_d2, double par_c, bool display_progress, bool ret_beta_nc, bool store_burn, bool sv, double Bsigma_sv, double a0_sv, double b0_sv, double bmu, double Bmu, bool SAVS);
RcppExport SEXP _PARCORwMNIG_do_shrinkTVP_mNIG(SEXP ySEXP, SEXP xSEXP, SEXP a0SEXP, SEXP KSEXP, SEXP niterSEXP, SEXP nburnSEXP, SEXP nthinSEXP, SEXP c0SEXP, SEXP g0SEXP, SEXP G0SEXP, SEXP eta2_d1SEXP, SEXP eta2_d2SEXP, SEXP p_d1SEXP, SEXP p_d2SEXP, SEXP par_cSEXP, SEXP display_progressSEXP, SEXP ret_beta_ncSEXP, SEXP store_burnSEXP, SEXP svSEXP, SEXP Bsigma_svSEXP, SEXP a0_svSEXP, SEXP b0_svSEXP, SEXP bmuSEXP, SEXP BmuSEXP, SEXP SAVSSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(do_shrinkTVP_mNIG(y, x, a0, K, niter, nburn, nthin, c0, g0, G0, eta2_d1, eta2_d2, p_d1, p_d2, par_c, display_progress, ret_beta_nc, store_burn, sv, Bsigma_sv, a0_sv, b0_sv, bmu, Bmu, SAVS));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_PARCORwMNIG_pred_dens_mix_approx", (DL_FUNC) &_PARCORwMNIG_pred_dens_mix_approx, 13},
    {"_PARCORwMNIG_do_shrinkTVP_mNIG", (DL_FUNC) &_PARCORwMNIG_do_shrinkTVP_mNIG, 25},
    {NULL, NULL, 0}
};

RcppExport void R_init_PARCORwMNIG(DllInfo *dll) {
